...
class DFExtender(pyspark.sql.dataframe.DataFrame):
    ...
    def _analyze_pk(self):
        ...
        if self.pk:
            ...
            # it is possible to rewrite using data from previous calculations
            # so we don't groupby second time. Would only require filter and order
            # but is it a big optimization?
    ...
    def __compare_calc_diff(self):
        ...
        # may be I should reorder this: col1_ref, col1_main, col1_diff, col_next_ref...
