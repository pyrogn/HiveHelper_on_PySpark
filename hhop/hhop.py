...
class DFExtender(pyspark.sql.dataframe.DataFrame):
    ...
    def __compare_calc_diff(self):
        ...
        columns_diff_postfix = [column + diff_postfix for column in self._common_cols]
        ...
        def add_column_is_diff(df, column):
            ...
            return df.withColumn(column + diff_postfix, F.expr(cond_diff))
    ...
    def __compare_calc_pk(self):
        ...
        cnt_results = []
        for key, condition in self._cases_full_join.items():
